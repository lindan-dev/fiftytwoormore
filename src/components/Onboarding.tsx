...
const slides = [
  ...
  {
    icon: Clock,
    title: "Make time for each other (for real).",
    subtitle: "Life gets busy. This tiny app helps you actually make time for intimacy — and laugh about it too.",
  },
  {
    icon: Calendar,
    title: "52 or more.",
    subtitle: "Once a week, every week — or more if you can. Just log it, keep your streak, and celebrate consistency.",
  },
  {
    icon: Lock,
