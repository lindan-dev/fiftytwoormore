...
const Index = () => {
  ...
  return (
    <div className="min-h-screen bg-background pb-16">
      ...
      {showInstallPrompt && (
        <Alert className="max-w-2xl mx-auto m-2 sm:m-4 p-2 sm:p-4 border-2 border-primary/30 bg-gradient-to-r from-primary/5 to-primary/10">
          <Download className="h-3 w-3 sm:h-4 sm:w-4 text-primary flex-shrink-0" />
          <AlertDescription className="flex items-center justify-between gap-1.5 sm:gap-2">
            <span className="text-xs sm:text-sm flex-1 leading-tight">Install app for offline access & better experience</span>
